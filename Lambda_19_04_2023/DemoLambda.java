...
public class DemoLambda{
	public static void main(String[] args) {
        ...
        //Se imprime la lista de alumnos mediante una funcion lambda
		listaAlumnos.stream().forEach(a->System.out.println(a));	
		
        //Usamos la funcion filter para descartar aquellos  alumnos con las iniciales L y G
		...
		System.out.println("\n**** Número de Alumnos ***");
		// Desplegamos el numero de alumnos en la lista
		System.out.println(listaAlumnos.stream().count());

		System.out.println("\n**** Alumnos con nota mayor a 9 y que sean del curso PHP ***");
		// Nuevamente haciendo uso de la funcion filter descartamos un grupo de alumnos
		listaAlumnos.stream().
		...
		// Ahora hacemos uso de la funcion min para obtener el alumno con menor edad
		System.out.println(listaAlumnos.stream().min((a1, a2) -> a1.getEdad() - a2.getEdad()));

		System.out.println("\n**** Imprimir el alumno con mayor edad ***");
		// Hacemos uso de la funcion max para imprimir el alumno con mayor edad
		System.out.println(listaAlumnos.stream().max((a1, a2) -> a1.getEdad() - a2.getEdad()));

		System.out.println("\n**** Encontrar el primer Alumno***");
		// fundFirst, para obtener el primer alumno de la lista
		System.out.println(listaAlumnos.stream().findFirst());

        //Se usa la función endsWith para comprobar si un cierto String termina con ese caracter
        ...
        //Se usa la función contains para verificar que un String contenga un cierto caracter sin importar la posicion
